...
export function Receive(OnReceive: (resp: BaseResp<AssetInfo> | undefined) => void, assetAddress: string, token: string, inviteCode: string ) {

    const url = getUrl('asset/receive?assetAddress=' + assetAddress + `&inviteCode=${inviteCode}`);
