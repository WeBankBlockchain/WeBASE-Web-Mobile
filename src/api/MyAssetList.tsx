...
export function MyAssetList(OnMyAssetList: (resp: BaseResp<AssetInfo[]> | undefined) => void, assetAddress: string, token: string) {

    const url = getUrl('asset/myAssetList?pageNumber=1&pageSize=100&assetAddress=' + assetAddress);
